...
import { deleteDocument } from "../../utils/api"; // Add this to your existing imports
...
export default function Dashboard() {
  ...
  const handleDelete = async (docId: string) => {
    ...
    try {
      ...
      // FIX: Use setDocs instead of setDocuments, and add TypeScript types
      setDocs((prevDocs: Document[]) => prevDocs.filter((doc: Document) => doc.id !== docId));
        ...
        <div className="bg-white p-6 rounded-xl shadow-md h-fit md:col-span-1">
          ...
          <div className="space-y-2">
                ...
                <div key={doc.id} className="flex justify-between items-center p-2 bg-gray-50 rounded text-xs">
                    ...
                    {/* The New Delete Button and Status Container */}
